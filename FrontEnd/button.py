...
class Button:
    def __init__(self, rectangle, color = (100,100,100), screen = None, padding_color = None,
                  message = None, border_radius = 0, font_size = 50, font_padding = (0,0), padding = False, padding_size = 5, font_color = (0,0,0)):
        ...
        self.text_surface = self.font.render(self.message, True, font_color)
    ...
    def update_message(self,message):
        self.message = message
        self.text_surface = self.font.render(message, True, self.font_color)
