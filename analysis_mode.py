...
def render_board(screen, board, black=(181, 136, 99), white=(244, 220, 180), board_size=700):
    ...
    render_background(screen, (board_size, board_size), black, white)
...
def display_promotion_click_manager(event, position, board_size, square_clicked, chess_board):
...
def make_a_move_click_manager(square_clicked_bool, event, board_size, chess_board):
    chess_board, display_promotion = make_a_move(square_clicked_bool, event.pos, board_size, chess_board)
    position = event.pos
    square_clicked_bool = None
    return chess_board, display_promotion, position, square_clicked_bool
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                if display_promotion:
                    chess_board, display_promotion = display_promotion_click_manager(event, position, board_size,
                                                                                     square_clicked, chess_board)

                elif square_clicked_bool:
                    chess_board, display_promotion, position, square_clicked_bool = \
                        make_a_move_click_manager(square_clicked_bool, event, board_size, chess_board)
