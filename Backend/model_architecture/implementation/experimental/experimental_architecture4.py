...
# I litteraly just added one block and increase the sizing compared to before
# v 1.1.1.1
...
def experimental_architecture1():
    ...
    # 8x8 -> 64x64
    x = layers.UpSampling2D(size=(8, 8))(input_layer)
    ...
    # Final Dense
    # TODO add DENSE 
    x = layers.Dense(128, activation='relu', name='fc64')(x)
    x = layers.Dense(128, activation='relu', name='fc64')(x)
